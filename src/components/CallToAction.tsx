  ...
  return (
    <div className="bg-black text-white py-[72px] sm:py-24 text-center overflow-hidden" ref={containerRef}>
      <div className="container max-w-xl relative">
        ...
        <motion.div style={{translateY}}>
        <Image src={emojiStar} alt="" className="absolute -top-[120px] right-[calc(100%+24px)] hidden sm:inline" />
        </motion.div >
        ...
        <form className="mt-10 flex flex-col gap-2.5 max-w-sm mx-auto sm:flex-row">
          ...
          />
          <button className="bg-white text-black h-12 rounded-lg font-medium px-5">Get access</button>
        </form>
      </div>
    </div>
  );
